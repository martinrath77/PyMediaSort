...
for picture in picture_list:
    ...
    if image_path.suffix.lower() in ['.jpg','.jpeg','.png','.mov','.mp4','.gif','.3gp']:
        ...
        # Checking if the Exif DateTimeOriginal key exists and using this whenever possible to determine the date the picture/video was taken
        try:
        ...
        # Finaly we move the file to the right directory
